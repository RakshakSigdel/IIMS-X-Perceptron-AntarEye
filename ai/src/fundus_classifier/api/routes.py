...
async def predict_endpoint(image: UploadFile = File(...)):
    ...
    if file_size > MAX_SIZE:
        raise HTTPException(status_code=400, detail="Invalid image. File size exceeds 10 MB limit.")
    ...
    try:
        ...
        # Run prediction
        try:
            pred_dict, class_name, conf, input_tensor = model_service.run_prediction(temp_path)
        ...
        try:
            ...
            pass # Continue if heatmap fails
